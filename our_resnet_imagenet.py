...
class ResNet_ImageNet(ResNet):
    def __init__(self, block, num_blocks, num_classes=1000, return_features=False):
        ...
        self.linear_classfier0 = nn.Linear(2048, num_classes)
        self.linear_classfier1 = nn.Linear(2048, num_classes)
        self.linear_classfier2 = nn.Linear(2048, num_classes)
    ...
    def forward_classifier(self, p4):
        logits0 = self.linear_classfier0(p4) # (10)
        logits1 = self.linear_classfier1(p4)
        logits2 = self.linear_classfier2(p4)
